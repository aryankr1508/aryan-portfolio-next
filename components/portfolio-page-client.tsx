...
export default function PortfolioPageClient({
  ...
  const primarySocialLinks = socialLinks.filter((social) => social.primary);
  const additionalSocialLinks = socialLinks.filter(
    (social) => !social.primary
  );
  const brandInitials = personalInfo.name
    .split(/\s+/)
    .map((part) => part[0])
    .join("")
    .slice(0, 2)
        ...
        <StageSection id="about" tone="mint" containerClass={containerClass}>
              ...
              <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                <Reveal className="surface-panel showcase-card card-about p-7 sm:p-8">
                  <h3 className="font-display text-2xl font-semibold text-slate-900">{siteCopy.about.highlightsTitle}</h3>
                ...
                <Reveal delay={0.08} className="surface-panel showcase-card card-about p-7 sm:p-8">
                  <h3 className="font-display text-2xl font-semibold text-slate-900">{siteCopy.about.stackTitle}</h3>
                  ...
                  <p className="mt-6 text-sm leading-relaxed text-slate-600">
                    {siteCopy.about.educationSummary}
                  </p>
                </Reveal>
              </div>
        </StageSection>
        ...
        <StageSection id="resume" tone="amber" containerClass={containerClass}>
              ...
              <Reveal className="surface-panel showcase-card card-resume card-resume-panel p-6 sm:p-8">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div>
                    <p className="font-display text-2xl font-semibold text-slate-900">{siteCopy.resume.downloadTitle}</p>
                    <p className="mt-1 text-sm text-slate-600">{siteCopy.resume.downloadDescription}</p>
                  </div>
                  <a
                    href={personalInfo.resumeFile}
                    target="_blank"
              ...
              <div className="grid gap-6 xl:grid-cols-2">
                <Reveal className="surface-panel showcase-card card-resume card-resume-panel p-7 sm:p-8">
                  <h3 className="font-display text-2xl font-semibold text-slate-900">{siteCopy.resume.experienceTitle}</h3>
                ...
                <Reveal delay={0.08} className="surface-panel showcase-card card-resume card-resume-panel p-7 sm:p-8">
                  <h3 className="font-display text-2xl font-semibold text-slate-900">{siteCopy.resume.educationTitle}</h3>
              ...
              <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
                ...
                <Reveal delay={0.08} className="surface-panel showcase-card card-contact p-7 sm:p-8">
                  <div className="space-y-3 pb-3">
                    <p className="font-display text-2xl font-semibold text-slate-900">{siteCopy.contact.briefTitle}</p>
